...
public class ClientFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Удалить будильник");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(t != null)
        {
            try {
                ...
                Msg msg = new Msg("a" + a.get_time_alarm());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if(t != null)
        {
            try {
                //Msg msg = new Msg(jTextField1.getText());
                Alarm a = new Alarm(0, 0, 0);
                a.setHour((int)jSpinner4.getValue());
                a.setMin((int)jSpinner5.getValue());
                a.setSec((int)jSpinner6.getValue());
                Msg msg = new Msg("d" + a.get_time_alarm());
                // снова используем gson, чтобы получить объект для отправки
                String s_string = gson.toJson(msg);
                dos.writeUTF(s_string);
            } catch (IOException ex) {
